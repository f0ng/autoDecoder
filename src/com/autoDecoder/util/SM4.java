...
//            }
            ...
            System.out.println("SM4  " + inputHex);
            int i = inputHex.lastIndexOf("80");
            if (i == -1)
                i = inputHex.lastIndexOf("0b"); // 新增
            if (i == -1)
                i = inputHex.lastIndexOf("0a"); // 新增
            if (i == -1)
                i = inputHex.lastIndexOf("0c"); // 新增
            if ( i == -1)
                i = inputHex.length();

            String substring = inputHex.substring(0, i);
            ret= Util.hexToByte(substring);
            System.out.println("208  "+Arrays.toString(ret));
        }
        return ret;
    }
